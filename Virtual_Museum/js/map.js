var map = L.map('Valletta').setView([35.8989, 14.5146], 15);
  ...
  L.marker([35.8964252381586, 14.510927456632919]).bindPopup( 'Jean de Valette (1495-1568)<p><a href="https://en.wikipedia.org/wiki/Jean_Parisot_de_Valette" target="_blank"><u>www.jeandevalette.com</a></u></p>').addTo(map);
  ...
  L.marker([35.8954520, 14.5103746]).bindPopup( 'Sena Internazzjonali Taż-Żgħażagħ').addTo(map);
  ...
  L.marker([35.893790, 14.505596]).bindPopup( 'The Mall').addTo(map);
  L.marker([35.893730, 14.505503]).bindPopup( 'Joseph Scicluna (1903-1970)<p><a href="https://www.dreamstime.com/joseph-scicluna-monument-publiju-floriana-malta-european-historical-landmark-joseph-scicluna-monument-publiju-floriana-malta-photo-image196790507" target="_blank"><u>www.josephscicluna.com</a></u></p>').addTo(map);
  L.marker([35.89310269682038, 14.504649436838736]).bindPopup( 'Ugo Pasquale Mifsud (1889-1942)<p><a href="https://en.wikipedia.org/wiki/Ugo_Pasquale_Mifsud" target="_blank"><u>www.hugomifsud.com</a></u></p>').addTo(map);